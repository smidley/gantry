...
//
//   LOGIN (8421): GANTRY_USERNAME + GANTRY_PASSWORD preseeded, the
...
//
//   SETUP (8422): boots with NO credential -- the first-run setup screen,
...
test.describe('login gate (preseeded instance)', () => {
  const PORT = 8421; // the suite's own block: config PORT+1 -- see playwright.config.ts
